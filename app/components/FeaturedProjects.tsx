...
export const FeaturedProjects = ({ data, theme }: { data: UserData; theme: Theme }) => (
  <section className="mb-32">
    <div className="flex items-center justify-between mb-12 opacity-0 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
      <h2 className={`text-3xl font-bold font-mono ${theme.colors.highlight}`}>Featured Projects</h2>
      <a href="/projects" className={`text-sm font-mono hover:underline decoration-2 underline-offset-4 ${theme.colors.accent} hover:animate-glow transition-all`}>View all →</a>
    </div>
