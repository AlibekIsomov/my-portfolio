...
export const DEFAULT_CONTENT: ContentMap = {
  ...
  home: {
    ...
    dashboardConnectButton: 'Book a Chat',
    ...
    dashboardLanguageGo: 'Go 40%',
    dashboardLanguageJs: 'JS 30%',
    dashboardLanguageTs: 'TS 20%',
  },
  about: {
    pageTitle: 'About Me',
  ...
  projects: {
    ...
    ctaBody: "I'm always interested in working on exciting projects. Feel free to reach out!",
