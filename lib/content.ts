...
export const DEFAULT_CONTENT: ContentMap = {
  ...
  home: {
    ...
    dashboardConnectBody: 'Always open to interesting projects and new opportunities.',
    ...
    dashboardCommitsTitle: 'Recent Commits (GitHub)',
    dashboardLanguageTitle: 'Language Stats (GitHub)',
  },
  about: {
    pageTitle: 'About Me',
    ...
    interestsItem2: 'Problem Solving',
    ...
    skillsLanguagesBody: 'PHP, Java, JavaScript, TypeScript',
    skillsFrontendTitle: 'Frontend',
    skillsFrontendBody: 'React, Next.js, Tailwind CSS, Vite',
    skillsBackendTitle: 'Backend & DevOps',
    skillsBackendBody: 'Php, Java, Sql, NoSql',
    skillsToolsBody: 'Git, Docker, VS Code, Linux, Docker, AWS',
  },
  contact: {
